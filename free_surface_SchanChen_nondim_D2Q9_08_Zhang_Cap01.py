...
CAPILLARY_PROOF = FlowConfig(
    ...
    a=1.0, b=6.7, T=3.5e-2,
    #tau_f=1.5, tau_g=1.0,
    tau_g=0.6, tau_f=1.00, #see eq(25) + Example A , t_g start with 0.6, increase as necessary -> was tau_f=0.65
...
while iteration < fc.TOTAL_ITERATIONS:
    ...
    z_gi_star, z_fi_star = bounceBackTopBottom_conservation(fc, iteration, z_gi_star, z_fi_star, Xn, Yn)
    

    #4.1b. top/bottom conservative bounceback
    #apply_periodic_boundary_conditions(_fi, _gi)    
    z_gi, z_fi = bounceBackLeftRight_conservation(fc, iteration, z_gi_star, z_fi_star, Xn, Yn)
