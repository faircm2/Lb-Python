...
# Initial plots
inlet_plot, = ax[0].plot([], [], label="Inlet Velocity", color="blue")
outlet_plot, = ax[1].plot([], [], label="Outlet Velocity", color="red")

# Set titles, labels, and legends
ax[0].set_title("Inlet Velocity Profile")
ax[0].set_ylabel("Velocity")
ax[0].legend()

ax[1].set_title("Outlet Velocity Profile")
...
while t < TOTAL_TIME:
    ...
    # Update plots
    inlet_plot.set_xdata(range(num_nodes))
    inlet_plot.set_ydata(u_avg_2[0, :])

    outlet_plot.set_xdata(range(num_nodes))
    outlet_plot.set_ydata(u_avg_N_1[0, :])
