...
######### logging ####################################################################################################
# Global debug level (set once at init, e.g., based on flags like VERBOSE1, ADD_METRICS)
# 0: none (suppress all)
...
while iteration < TOTAL_ITERATIONS:
    ...
    if iteration == 0 or iteration==(TOTAL_ITERATIONS - 1) or iteration % 100 == 0:
        if ADD_METRICS: 
            ...
            #debug_log('FIELD',f'Iteration={iteration}', f'max|u_x|={u_ckl_x_max:.2e}, invariant={invariant:.2e}')
